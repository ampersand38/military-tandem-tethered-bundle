...
def main():
    ...
    print("""
  ######################################
  # MTTB Development Environment Setup #
  ######################################

  This script will create your MTTB dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MTTB project folder:
    [Arma 3 installation directory]\\{} => MTTB project folder
    P:\\{}                              => MTTB project folder
